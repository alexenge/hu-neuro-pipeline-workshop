...
If you want to move straight on how to use the pipelne, please move on to Section 2.
...
log = pandas.read_csv("data/log/09_test.txt")
print(log)
```
...
raw = mne.io.read_raw_brainvision("data/raw/09.vhdr", preload=True)
raw.plot(duration=10.0, start=420.0)
```
