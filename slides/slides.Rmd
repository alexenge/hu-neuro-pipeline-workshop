...
# Change default color palette in ggplot to http://arxiv.org/abs/2107.02270
cols <- c("#5790fc", "#e42536", "#964a8b", "#9c9ca1", "#7a21dd")
scale_colour_discrete <- function(...) scale_colour_manual(..., values = cols)
scale_fill_discrete <- function(...) scale_fill_manual(..., values = cols)
```
