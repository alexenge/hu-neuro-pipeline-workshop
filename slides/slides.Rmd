...
- Interpolate bad channels (`bad_channel = "auto"`)
  ...
  - Based on per-channel standard error across all epochs

```{r, echo=FALSE, fig.align="right", out.width="46%"}
knitr::include_graphics(here("slides/figures/automate.png"))
```
...
knitr::include_graphics(here("slides/figures/one_more_thing.jpeg"))
```
